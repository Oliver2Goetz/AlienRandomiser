...
namespace OpenCAGE
{
    static class FontManager
    {
        ...
        static FontManager()
        {
            ...
            AddFont(fonts, AlienRandomiser.Properties.Resources.Isolation_Isolation);
            AddFont(fonts, AlienRandomiser.Properties.Resources.JixellationBold_Jixellation);
            AddFont(fonts, AlienRandomiser.Properties.Resources.NostromoBoldCond_Nostromo_Cond);
        }
